...
Plane.prototype.checkForHits = function(elapsed, p)
{
	...
	{		
		if(this.particle.mass > 0.0)
		{
			this.particle.vel[0] = this.particle.vel[0] - (this.restitution+1) * (this.normal[0]*this.particle.vel[0]) * this.normal[0];
			this.particle.vel[1] = this.particle.vel[1] - (this.restitution+1) * (this.normal[1]*this.particle.vel[1]) * this.normal[1]
			this.particle.vel[2] = this.particle.vel[2] - (this.restitution+1) * (this.normal[2]*this.particle.vel[2]) * this.normal[2]
		}
	}
}
////////////////////////////////////////////////////////////